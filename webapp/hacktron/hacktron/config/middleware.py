# -*- coding: utf-8 -*-
"""WSGI middleware initialization for the hacktron application."""

from hacktron.config.app_cfg import base_config
from hacktron.config.environment import load_environment
